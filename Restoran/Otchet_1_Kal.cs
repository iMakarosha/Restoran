...
namespace Restoran
{
    public partial class Otchet_1_Kal : Form
    {
        public Otchet_1_Kal()
        {
            InitializeComponent();
        ...
        {
            _Document oDoc = GetDoc(@"C:\Users\SurOk\Desktop\АС РР\\" + "\\1.dot");
